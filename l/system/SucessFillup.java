 ...
 */
public class SucessFillup extends javax.swing.JFrame {

    /**
     * Creates new form SucessFillup
     */
    public SucessFillup() {
        initComponents();
        setLocation(390,300);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Form is sent !!! Please have patience ..");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SucessFillup.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SucessFillup().setVisible(true);
            }
        });
    }
